...
<body>
    ...
    <nav>
        <a class="logo" href="index.php"> <img src="images/utsab-logo.png" alt="site-logo"> </a>
...
<div class="container mt-5">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            f.source_date, f.source_time, f.flight_class,
            CASE
                WHEN f.flight_class = 'Economy' THEN  f.price
                WHEN f.flight_class = 'Business' THEN  f.price
        ...
        WHERE c.email = '$user_email'"; // Filter by user_email
            ...
            if ($resultBookings->num_rows > 0) {
                while ($rowBooking = $resultBookings->fetch_assoc()) {
                    ...
                    echo "<td>" . $rowBooking["source_time"] . "</td>";
                    ...
                    echo"&nbsp&nbsp";
                    echo "<a href='payment.php?id=" . $rowBooking["id"] . "' class='btn btn-success btn-sm delete-booking' data-id='" . $rowBooking["id"] . "'>Payment</a>";
  ...
  <footer>
        ...
        <p>&copy 2024 Utsab Travels and Tourism </p>
    </footer>
