...
<body>
    ...
    <div class="container mt-5" style="margin-top: 150px; width: 50% ">
       
        <div class="right-column">
            <h3>Flight Booking</h3>
            <form method="POST" action="available-flights.php" onsubmit="return validateDepartureDate()">
        ...
        <script>
            function validateDepartureDate() {
                var departureDate = document.getElementById('source_date').value;
                 var today = new Date();
                 var todayFormatted = today.toISOString().split('T')[0];

                if (departureDate < todayFormatted) {
