...
if (isset($_POST['flight_but'])) {
    ...
    $sql = "INSERT INTO flight (source_date, source_time, dep_airport, arr_airport, seats, price, flight_class, airline_name, dep_airport_id, arr_airport_id, airline_email)
            VALUES ('$source_date', '$source_time', '$dep_airport', '$arr_airport', $seats, $price, '$flight_class', '$airline_name', $dep_airport_id, $arr_airport_id, '$airline_email')";
...
<style>
    ...
    <div class="container mt-0">
        <div class="row">
            ...
            <div class="bg-light form-out col-md-12">
                ...
                <form method="POST" class="text-center,form-flight-details" action="flightinc.php">
                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input type="number" name="seats" id="dura" min="0" required />
                            </div>
                        </div>
                        <div class="col">
                            <div class="input-group">
                                <label for="price">Price:</label>
                                <input type="number" style="border: 0px; border-bottom: 2px solid #5c5c5c;" name="price" id="price" min="0" required />
                            </div>
                        </div>
                        <div class="col">
    <select class="form-control" name="flight_class" required>
        ...
        <option value="First Class">First Class</option>
                        ...
                        <div class="col" id="select-airline">
                            <?php
                            ...
                            // Check if the query was successful
                            if ($result) {
                                echo '<select class="airline mt-2" name="airline_name" style="border: 0px; border-bottom: 
